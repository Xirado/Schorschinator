...
public class Shell
{
        ...
        Thread t = new Thread(() ->
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    String invoke = pl.words().get(0);
                    Main.COMMAND_HANDLER.handleCommand(terminal, invoke, argv);
    ...
    public static String getLogo()
    {
        ...
        String version = "Schorschinator 1.0 by Xirado";
        String github = "https://github.com/Xirado/Schorschinator";
        builder.append("\n").append(" ".repeat((width / 2) - (version.length() / 2))).append(version + "\n").append(" ".repeat((width / 2) - (github.length() / 2))).append(github + "\n").style(AttributedStyle.DEFAULT).append("\n\nFür eine Liste aller Befehle nutze ").style(PINK).append("help").style(AttributedStyle.DEFAULT).append(" oder ").style(PINK).append("?").style(AttributedStyle.DEFAULT).append(".");
